package fr.uga.m1miage.pc.prisonersdilemma.controllers;


import fr.uga.m1miage.pc.prisonersdilemma.dto.GameMessage;
import fr.uga.m1miage.pc.prisonersdilemma.dto.JoinMessage;
import fr.uga.m1miage.pc.prisonersdilemma.dto.LeaveMessage;
import fr.uga.m1miage.pc.prisonersdilemma.dto.PlayerMessage;
import fr.uga.m1miage.pc.prisonersdilemma.models.GameEncounter;
import fr.uga.m1miage.pc.prisonersdilemma.models.Player;
import fr.uga.m1miage.pc.prisonersdilemma.services.GameService;
...
public class MessageController{
    ...
    if (sessionAttributes != null && sessionAttributes.containsKey(PLAYER_NAME_KEY)) {
        ...
        if(playerName!=null){
            ...
            if(game!=null){
                fr.uga.m1miage.pc.prisonersdilemma.dto.GameMessage gameMessage = gameService.leaveGame(playerName, 1);
                messagingTemplate.convertAndSend(TOPIC_GAME1 + gameMessage.gameId(), gameMessage);
            }
